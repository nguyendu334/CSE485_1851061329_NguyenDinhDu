...
$id = $_GET['id'];
$sql = "SELECT * FROM kinang WHERE id=$id";
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    if(isset($_POST['sbm'])){
                        ...
                        $sql = "UPDATE kinang SET ngonngu = '$lang',congviec='$congviec' WHERE id=$id";
                        $query = mysqli_query($conn, $sql);
                        if($query){
